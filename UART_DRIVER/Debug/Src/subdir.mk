...
clean-Src:
	-$(RM) ./Src/UART_HAL.cyclo ./Src/UART_HAL.d ./Src/UART_HAL.o ./Src/UART_HAL.su ./Src/main.cyclo ./Src/main.d ./Src/main.o ./Src/main.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
